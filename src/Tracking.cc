...
namespace ORB_SLAM3 {
        ...
        if (mState == OK) {
          ...
          if (mState == RECENTLY_LOST) {
            ...
            if ((mSensor == System::IMU_MONOCULAR || mSensor == System::IMU_STEREO
              ...
              // std::endl; std::cout << "mTimeStampLost:" << to_string(mTimeStampLost) <<
              // std::endl;
        ...
        if (bTcw) {
          ...
          if (nGood < 50) {
            ...
            if (nadditional + nGood >= 50) {
              ...
              // If many inliers but still not enough, search by projection again in a narrower
              // window the camera has been already optimized with many points
  ...
  void Tracking::SaveSubTrajectory(string strNameFile_frames, string strNameFile_kf,
                                   string strFolder) {
